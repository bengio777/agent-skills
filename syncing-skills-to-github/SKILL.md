...
## Purpose
Sync Claude Agent Skills from `~/.claude/skills/` (local machine) to GitHub repository `bengio777/agent-skills` with detailed commit history and automated Notion tracking. Skills are stored in a flat directory structure. Part 2 of the two-skill export→sync workflow.
...
- Remote: `git@github.com:bengio777/agent-skills.git` or `https://github.com/bengio777/agent-skills.git`

### Notion
- AI Building Blocks database ID: `2fefb3a7-cad4-81ba-901b-000bd6f3fb6c`
...
if [ ! -d .git ]; then
    ...
    echo "  git init"
    echo "  git remote add origin git@github.com:bengio777/agent-skills.git"
    exit 1
fi
...
1. **Search for the skill in Notion AI Building Blocks:**
   ...
   - Parameters:
     ...
     - `data_source_url`: "collection://2fefb3a7-cad4-81ba-901b-000bd6f3fb6c"
...
3. **Build the GitHub URL:**
   - Format: `https://github.com/bengio777/agent-skills/tree/main/{skill-name}`
   - Example: `https://github.com/bengio777/agent-skills/tree/main/exporting-skills-from-claude`
...
2. GitHub URL: https://github.com/bengio777/agent-skills/tree/main/syncing-skills-to-github
...
📝 Commit: abc123f
🔗 https://github.com/bengio777/agent-skills/tree/main/writing-linkedin-posts
...
📝 Commit: def456g
🔗 https://github.com/bengio777/agent-skills
...
1. cd ~/.claude/skills
2. git init
3. git remote add origin git@github.com:bengio777/agent-skills.git
4. git add .
...
GitHub URL: https://github.com/bengio777/agent-skills
...
Local (~/.claude/skills/)
    ↓ [Sync] ← This skill
GitHub (github.com/bengio777/agent-skills)
    ↓ [Update URLs]
...
### Private Repository
- Repository `bengio777/agent-skills` is **private**
